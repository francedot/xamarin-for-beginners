...
namespace Movies.Services
{
    public class MobileAppMoviesSource : IMoviesSource
    {
        ...
        public MobileAppMoviesSource(MobileServiceClient mobileServiceClient = default(MobileServiceClient))
        {
        ...
        {
            _mobileServiceClient = _mobileServiceClient ?? new MobileServiceClient(MobileAppUrl);
